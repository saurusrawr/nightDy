...
installTheme(){
    ...
    rm -r nightDy
    git clone https://github.com/saurusrawr/nightDy.git
    cd nightDy
...
repair(){
    bash <(curl https://raw.githubusercontent.com/saurusrawr/nightDy/main/repair.sh)
}
...
echo "Copyright © lordsaurus | by saurus dev"
...
echo ""
echo "Discord:-"
echo "GitHub: https://github.com/saurusrawr"
echo "Telegram: @lordsaurus"
echo ""
echo "[1] Pasang tema"
